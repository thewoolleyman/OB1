...
| ------------ | ------------ | ------- |
| [Docs(agents): adopt ~/.worktrees/OB1/<branch> worktree path convention](dashboards/ob1-canonical-landing/) | Docs(agents): adopt ~/.worktrees/OB1/<branch> worktree path convention. | [@thewoolleyman](https://github.com/thewoolleyman) |
